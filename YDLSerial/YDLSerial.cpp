...
BEGIN_MESSAGE_MAP(CYDLSerialApp, CWinApp)
...
// 唯一的一个 CYDLSerialApp 对象

CYDLSerialApp theApp;


// CYDLSerialApp 初始化

BOOL CYDLSerialApp::InitInstance()
{
